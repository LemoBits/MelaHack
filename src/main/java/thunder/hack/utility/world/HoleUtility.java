...
public final class HoleUtility {
    ...
    public static @NotNull List<BlockPos> getHolePoses(@NotNull Vec3 from) {
    ...
    public static @NotNull List<BlockPos> getSurroundPoses(@NotNull Vec3 from) {
    ...
    private static @NotNull BlockPos getPos(@NotNull Vec3 from) {
