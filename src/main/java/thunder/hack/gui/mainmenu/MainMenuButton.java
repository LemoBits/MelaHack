...
public class MainMenuButton {
    ...
    public void onRender(GuiGraphicsExtractor context, float mouseX, float mouseY) {
        ...
        FontRenderers.source_han_sans_normal.drawCenteredString(context.pose(), name, halfOfWidth + posX + width / 2f, halfOfHeight + posY + height / 2f - 3f, hovered ? -1 : Render2DEngine.applyOpacity(-1, 0.7f));
    }
